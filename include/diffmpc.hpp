#ifndef NAV2_Diff_MPC_HPP_
#define NAV2_Diff_MPC_HPP_
...
class DiffMPC : public nav2_core::Controller
{
public:
  DiffMPC() = default;
  ~DiffMPC() override = default;
...
protected:
  ...
  rclcpp::Logger logger_ {rclcpp::get_logger("DiffMPC")};
  ...
  double virtual_laser_interval, virtual_laser_range;
  double sl_p, sl_a, l_slack, acc_slack;
  bool if_do_goalctrl_, if_do_failcheck_;
